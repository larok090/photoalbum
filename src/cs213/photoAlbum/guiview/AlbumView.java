		...
		public void actionPerformed(ActionEvent e) 
		{
			if(buttons[1].isSelected()){
				...
				//String fileName = null, caption = null;
						...
						userControl.addAlbum("Search Results");
							...
							for(Album album :albums)
							{
								for(Photo photo :album.getPhotos())
								{
									...
									//	String caption=photo.getCaption();
										...
										userControl.copyPhoto(photo.getPhotoPath(), album.getAlbumName(), "Search Results");
						...
						if(userControl.usr.getAlbum("Search Results").getPhotos().size()==0){
							JOptionPane.showMessageDialog(null, "there are no existing photos with your search", "Error",
									JOptionPane.ERROR_MESSAGE);
							userControl.deleteAlbum("Search Results");
							return;
						}
						else{
							searchFrame.dispose();
							okSearch = true;
							dispose();
							new AlbumPhotos(userControl,"Search Results",true);
						}
